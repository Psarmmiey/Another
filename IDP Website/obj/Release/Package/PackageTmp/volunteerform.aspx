<%@ Page Title="Volunteer Form" Language="C#" AutoEventWireup="true" CodeBehind="volunteerform.aspx.cs" MasterPageFile="~/Site.Master" Inherits="IDP_Website.ApplicationForms.volunteerform" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="padding-left:100px; padding-right:100px;">
        <div class="col-md-6">
            ...
            <div class="col-md-12">
                <p class="btn-lg">Role Specification<asp:DropDownList ID="TextBox4" runat="server" CssClass="btn-lg form-control" Font-Names="Calibri" PlaceHolder="What can you do?"></asp:DropDownList></p>
            </div>
            <div class="col-md-12">
                <p class="btn-lg" style="text-align:left;">Any Past Experience<asp:TextBox ID="TextBox5" runat="server" CssClass="btn-lg form-control" TextMode="MultiLine" Font-Names="Calibri" PlaceHolder="Any Qualifications, have you done this kind of work before?"></asp:TextBox></p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-left:500px;">
            <asp:Button runat="server" CssClass="btn-lg" Text="Volunteer" ForeColor="Black" />
        </div>
    </div>
    <br />
    <br />
